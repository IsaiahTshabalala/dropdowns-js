/**
 * File: ./src/dropdowns/CollectionsProvider.js
 * Description:
 * A useContext based hook.
 * The purpose of this hook is to enable components to share collections of data.
 * An example of a typical application:
 * A component that has dropdowns. Each dropdown displays a collection that is shared with the parent component (e.g. form).
 * Each dropdown may get the collection data (items), and set the selected items.
 * The parent component (e.g. form) may add a new collection, update the collection data, set and get the selected items.
 * It may also set selected items, in a data pre-population case.
 * 
...
export function CollectionsProvider({children}) {
    ...
    */
    ...
    // Get the maximum number of selections allowed on a collection.
...
class Collection {
    ...
    */
    ...
    setSelectedItems(pSelectedItems) {
        // Do not proceed if the number of selected items exceeds 
